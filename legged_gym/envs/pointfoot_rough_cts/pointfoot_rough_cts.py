...
from .pointfoot_rough_cts_config import BipedCfgPFCTS

class BipedPFCTS(BaseTask):
    
    def __init__(
        self, cfg: BipedCfgPFCTS, sim_params, physics_engine, sim_device, headless
    ):
    ...
    def compute_group_observations(self):
        ...
        #  print("critic_obs_buf", critic_obs_buf.shape)
